...
#define DIP_BASE XPAR_AXI_GPIO_0_BASEADDR
#else
#define NO_GPIOS
#endif
...
#define LED_BASE XPAR_GPIO_1_BASEADDR
#else
#define NO_GPIOS
#endif
...
/*
    ch1_sw = *(volatile unsigned int *)(DIP_BASE);
    ch2_sw = *(volatile unsigned int *)(DIP_BASE+8);
    ret_val = (ch1_sw <<4) | ch2_sw;
    return ret_val;
*/
#endif
}
