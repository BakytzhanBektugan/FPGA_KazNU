...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set eth_phy_clk [ create_bd_port -dir O -type clk eth_phy_clk ]
  ...
  set_property -dict [ list CONFIG.C_S_AXI_PROTOCOL {AXI4} CONFIG.MDIO_BOARD_INTERFACE {eth_mdio_mdc} CONFIG.MII_BOARD_INTERFACE {eth_mii} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernetlite_0
  ...
  set_property -dict [ list CONFIG.GPIO_BOARD_INTERFACE {led_4bits} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_1
  ...
  set_property -dict [ list CONFIG.CLKOUT1_JITTER {114.829} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {200.000} CONFIG.CLKOUT2_JITTER {118.758} CONFIG.CLKOUT2_PHASE_ERROR {98.575} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {166.667} CONFIG.CLKOUT2_USED {true} CONFIG.CLKOUT3_JITTER {175.402} CONFIG.CLKOUT3_PHASE_ERROR {98.575} CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {25.000} CONFIG.CLKOUT3_USED {true} CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} CONFIG.MMCM_CLKOUT0_DIVIDE_F {5.000} CONFIG.MMCM_CLKOUT1_DIVIDE {6} CONFIG.MMCM_CLKOUT2_DIVIDE {40} CONFIG.MMCM_DIVCLK_DIVIDE {1} CONFIG.NUM_OUT_CLKS {3} CONFIG.USE_BOARD_FLOW {true} CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false}  ] $clk_wiz_0
...
CONFIG.C_CACHE_BYTE_SIZE {32768} CONFIG.C_DCACHE_BYTE_SIZE {32768} \
CONFIG.C_DCACHE_LINE_LEN {8} CONFIG.C_DEBUG_ENABLED {1} \
CONFIG.C_D_AXI {1} CONFIG.C_D_LMB {1} \
CONFIG.C_ICACHE_LINE_LEN {8} CONFIG.C_ILL_OPCODE_EXCEPTION {0} \
CONFIG.C_I_LMB {1} CONFIG.C_MMU_ZONES {2} \
CONFIG.C_M_AXI_D_BUS_EXCEPTION {1} CONFIG.C_M_AXI_I_BUS_EXCEPTION {0} \
CONFIG.C_NUMBER_OF_PC_BRK {2} CONFIG.C_OPCODE_0x0_ILLEGAL {0} \
CONFIG.C_UNALIGNED_EXCEPTIONS {0} CONFIG.C_USE_BARREL {1} \
CONFIG.C_USE_BRANCH_TARGET_CACHE {0} CONFIG.C_USE_DCACHE {1} \
CONFIG.C_USE_DIV {1} CONFIG.C_USE_HW_MUL {1} \
CONFIG.C_USE_ICACHE {1} CONFIG.C_USE_MMU {0} \
CONFIG.C_USE_MSR_INSTR {1} CONFIG.C_USE_PCMP_INSTR {1} \
CONFIG.G_TEMPLATE_LIST {6} CONFIG.G_USE_EXCEPTIONS {1} \
 ] $microblaze_0
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_ports eth_phy_clk] [get_bd_pins clk_wiz_0/clk_out3]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_ethernetlite_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk]
